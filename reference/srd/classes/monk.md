...
**Armor Training:** None
**Weapon Proficiencies:** Simple; Martial weapons that have the Light property
...
| Level | PB | Features | Martial Arts | Focus Points | Unarmored Movement |
| --- | --- | --- | --- | --- | --- |
| 1st | +2 | Martial Arts, Unarmored Defense | 1d6 | 0 | +0 ft. |
