...
**Proficiencies Gained:** Armor: Light; Medium; Shield; Weapons: Martial

## Paladin Features

| Level | PB | Features | Channel Divinity | Prepared Spells |
| --- | --- | --- | --- | --- |
| 1st | +2 | Lay on Hands, Spellcasting, Weapon Mastery | 0 | 2 |
| 2nd | +2 | Fighting Style, Paladin's Smite | 0 | 3 |
...
*Fighting Style option: Blessed Warrior*
