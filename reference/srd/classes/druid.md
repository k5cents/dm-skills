...
**Armor Training:** Light; Shield
**Weapon Proficiencies:** Simple
**Tool Proficiencies:** Herbalism Kit

## Starting Equipment

Choose A or B: (A) Leather Armor, Shield, Sickle, Druidic Focus (Quarterstaff), Explorer's Pack, Herbalism kit, 9 GP; or (B) 50 GP

## Multiclassing

**Proficiencies Gained:** Armor: Light; Shield

## Druid Features

| Level | PB | Features | Wild Shape | Cantrips | Prepared Spells |
| --- | --- | --- | --- | --- | --- |
| 1st | +2 | Druidic, Primal Order, Spellcasting | 0 | 2 | 4 |
